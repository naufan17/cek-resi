...
const Option: React.FC<OptionProps> = ({ courier, handleInputChange, option }) => {
  return (
    <select
      ...
      className="flex-grow w-full sm:h-12 h-9 px-4 sm:text-base text-md text-slate-900 transition rounded-xl shadow-md bg-slate-100 border border-slate-600 appearance-none  focus:ring-2 focus:ring-slate-400 focus:shadow-outline focus:outline-none"
    >
